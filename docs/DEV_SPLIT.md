...
- ⏸ **보류 / 제외:**
  - 글쓰기 "무한 두루마리" 연출 — **불필요하다고 판단해 진행하지 않기로 함**
  - 홈→글쓰기 전환 애니메이션 — 전환을 거는 코드(`Navigator.push`)가 **P1 소유 파일(`home_screen.dart`)에 귀속**돼 있어, P2 단독 진행 보류 (P1 협의 필요)
  - 의식 진입 stagger 모션 — 보류 (카드 탭 반전 피드백으로 충분하다 판단)
