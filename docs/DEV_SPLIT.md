...
아직 팀 합의가 안 된 항목. 도입 여부를 정한 뒤 위 작업 목록으로 옮긴다.

- **ASMR/사운드 레이어** (`audioplayers`) — 넣을지 결정 필요 (리뷰: jyj-1101, jiyoungmm)
- **해소 기록·누적 표시** — "N번 흘려보냈어요" 통계가 제외되면서 함께 보류. 기록을 남길지/어디에 보여줄지 협의 필요.

> 리뷰에서 **감정 선택(감정→색 매핑)**, **"N번 흘려보냈어요" 통계**, **꽉쥐기 제스처**는 미협의/구현 불가로 제외했습니다.
